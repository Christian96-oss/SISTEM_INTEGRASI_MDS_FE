...
const AgentCard = ({ id, name, email, avatar, noOfProperties }: AgentCardProp) => {
  ...
  return (
    ...
    >
      <img src={checkImage(avatar) ? avatar : "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png"} alt="user" width={90} height={90} style={{ borderRadius: 8, objectFit: "cover" }} />
      <Stack direction="column" justifyContent="space-between" flex={1} gap={{ xs: 4, sm: 2 }}>
        ...
        <Stack direction="row" flexWrap="wrap" justifyContent="space-between" alignItems="center" gap={2}>
          ...
          <InfoBar icon={<Place sx={{ color: "#808191" }} />} name="Batam" />
          <InfoBar icon={<Phone sx={{ color: "#808191" }} />} name="+628-3231-4141" />
